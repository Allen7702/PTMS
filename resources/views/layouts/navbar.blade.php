 ...
 <nav class=" navbar navbar-expand color-blue navbar-light">
    <!-- Left navbar links -->
      ...
      <div class="d-flex ">
       ...
       <ul class="nav-links">
        <li><a href="{{route('dashboard.index')}}" class="text-lg mx-4">Student</a></li>
        <li><a href="{{route('dashboard.index')}}">Location Preference</a></li>
        <li><a href="{{route('student.company')}}">PT Allocation</a></li>
        <li><a href="{{route('dashboard.index')}}">Resources</a></li>
       </ul>
    </div>
          ...
          <a href="#" class="dropdown-item">
            ...
            <!-- <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">submitted logbook week 1.</p>
