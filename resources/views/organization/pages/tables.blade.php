                          ...
                          <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                              <thead class="align-bottom">
                                  <tr>
                                      ...
                                      <th class="pr-40 py-3 font-semibold capitalize align-middle bg-transparent border-b border-gray-200 border-solid shadow-none tracking-none whitespace-nowrap text-slate-400 opacity-70">College</th>
                                  </tr>
                              </thead>
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td class="px-6 py-3 text-sm leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                          <!-- Department -->
                                          <p class="mb-0 text-sm leading-normal">Computer Science and Engineering</p>
                                      </td>
                                      ...
                                      <td class="px-6 py-3 align-middle  bg-transparent border-b whitespace-nowrap shadow-transparent" >
                                          <!-- College -->
                                          <p class="mb-0  text-sm leading-normal">COICT</p>
                                      </td>
                                  </tr>
                                  <tr>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Student Name -->
                                        <p class="mb-0 text-sm leading-normal">Allen A Mgeyekwa</p>
                                    </td>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Course -->
                                        <p class="mb-0 text-sm leading-normal">Computer Science</p>
                                ...
                                <tr>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Student Name -->
                                        <p class="mb-0 text-sm leading-normal">Valence Mlogwe</p>
                                    </td>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Course -->
                                        <p class="mb-0 text-sm leading-normal">Business Information Technology</p>
                                    </td>
                                    <td class="px-6 py-3 text-sm leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Department -->
                                        <p class="mb-0 text-sm leading-normal">Computer Science and Engineering</p>
                                ...
                                <tr>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Student Name -->
                                        <p class="mb-0 text-sm leading-normal">Rachel Moses</p>
                                    </td>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Course -->
                                        <p class="mb-0 text-sm leading-normal">Computer Science</p>
                                ...
                                <tr>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Student Name -->
                                        <p class="mb-0 text-sm leading-normal">Karim Nyumba</p>
                                    </td>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Course -->
                                        <p class="mb-0 text-sm leading-normal">Computer Science and enginering</p>
                                    </td>
                                    <td class="px-6 py-3 text-sm leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Department -->
                                        <p class="mb-0 text-sm leading-normal">Computer Science and Engineering</p>
                                    ...
                                    <td class="px-6 py-3 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Year -->
                                        <p class="mb-0 text-sm leading-normal">2</p>
                                    </td>
                                    <td class="px-6 py-3 align-middle  bg-transparent border-b whitespace-nowrap shadow-transparent" >
                                        <!-- College -->
                                        <p class="mb-0  text-sm leading-normal">COICT</p>
                                ...
                                <tr>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Student Name -->
                                        <p class="mb-0 text-sm leading-normal">Saroni</p>
                                    </td>
                                    <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Course -->
                                        <p class="mb-0 text-sm leading-normal">Computer Science</p>
                                    ...
                                    <td class="px-6 py-3 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <!-- Year -->
                                        <p class="mb-0 text-sm leading-normal">4</p>
                                    </td>
                                    <td class="px-6 py-3 align-middle  bg-transparent border-b whitespace-nowrap shadow-transparent" >
                                        <!-- College -->
                                        <p class="mb-0  text-sm leading-normal">COICT</p>
